  ...
  return (
    <section id="equipa" className="py-32 bg-brand-paper border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 mb-32 max-w-6xl mx-auto">
          {clinicalTeam.map((member, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative aspect-[3/4] overflow-hidden rounded-none mb-6 shadow-2xl border border-white/5 mx-auto">
                <img 
                  src={member.image} 
                  alt={member.name} 
                ...
                />
                <div className="absolute inset-0 bg-brand-paper/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center p-4">
              ...
              <div className="text-center">
                <h3 className="serif text-2xl text-white mb-2 leading-none">{member.name}</h3>
