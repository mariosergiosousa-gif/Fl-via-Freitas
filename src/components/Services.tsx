  ...
  return (
    <section id="tratamentos" className="relative py-24 md:py-32 bg-brand-paper border-t border-white/10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-12 gap-8 text-left">
          <div className="max-w-2xl">
            ...
            <p className="text-slate-400 text-base md:text-lg font-light leading-relaxed max-w-lg md:mx-0 mb-4">
